...
/***************************************
 *
 * NavModal for YouTube demo video
 *
 **************************************/
...
const NavModal = (props) => {
  ...
  return (
    <>
      <section className="fixed top-0 left-0 w-full h-full opacity-100 bg-navModalOpenBg backdrop-blur-sm transition-opacity duration-300 ease-out z-100 animate-videoModal">
        <div className="flex justify-center items-center h-screen">
          <div className="bg-transparent text-right h-auto w-full rounded-2xl mx-4 shadow-navModalOpenShadow  text-black md:w-[800px] md:mx-16 sm:h-[500px]">
            ...
            <div className="bottom-0 flex relative sm:bottom-9">
              {videoLoading ? (
                <div className="fixed top-2/4 left-2/4 -translate-x-2/4 -translate-y-2/4 text-blue-700 text-4xl">
